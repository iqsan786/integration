...
# SYSTEM
# --------------------------------------------------
class SuspendedLoadSystem:

    # 🔥 ROUTING CONTROL
    SUPPORTED_ANALYTICS = {"ob-suspended_load_detection"}
    ...
    def __init__(self, config):
        ...
        logger.info("[INIT] Suspended Load System Ready")
    ...
    def process_frame(self, frame, msg):
        ...
        for group in camera_config.get("readerMetrics", []):
            ...
            for metric in group.get("metricJson", []):
                for st in metric.get("subType", []):
                    ...
                    if st.get("name") != "ob-suspended_load_detection":
                        continue
        ...
        for analytics in analytics_list:
            ...
            logger.info("[PUBLISH] Suspended Load Detected")
